...
class PaymentSerializer(serializers.ModelSerializer):
    price = serializers.FloatField(initial='4', default='4', help_text='Payment price')
    detail = serializers.CharField(initial='Cash', default='Cash', help_text='Payment detail')
